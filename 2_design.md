...
##### 3. Màn hình Chọn Ghế (Seat Selection Screen - `seat-selection.ejs`)
...
##### 4. Màn hình Thanh Toán (Payment Screen - `checkout.ejs`)
...
##### 5. Màn hình Hóa Đơn (Receipt Screen - `receipt.ejs`)
...
#### 6. Màn hình Tài Khoản (Profile Screen - `profile.ejs`)
...
#### 5.2.5 Hóa đơn xác nhận  

#### 5.2.6 Thông tin cá nhân & lịch sử thanh toán   
